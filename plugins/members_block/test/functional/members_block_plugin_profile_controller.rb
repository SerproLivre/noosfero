...
require File.dirname(__FILE__) + '/../../controllers/members_block_plugin_profile_controller'


# Re-raise errors caught by the controller.
class MembersBlockPluginProfileController; def rescue_action(e) raise e end; end

class MembersBlockPluginProfileControllerTest < ActionController::TestCase

  def setup
    @controller = MembersBlockPluginProfileController.new
    ...
    @environment.enabled_plugins = ['MembersBlockPlugin']
    @environment.save!
  ...
  should 'list members without role_key' do
    ...
    assert_equal [@admin, @member, @moderator], assigns(:members)
